...
export default class PhotoSlide {
  constructor() {
    this.selector = ".photo-slide__swiper";
    this.init();
  }
  ...
  initFancybox() {
    Fancybox.bind('[data-fancybox="photo-slide-gallery"]', {
      groupAll: false,
    });
  }
  ...
  initSwiper(sliderEl) {
    new Swiper(sliderEl, {
      ...
      loop: true,
      navigation: {
        nextEl: ".photo-slide__btn--next",
        prevEl: ".photo-slide__btn--prev",
      },
      pagination: {
        el: ".photo-slide__pagination",
        clickable: true,
